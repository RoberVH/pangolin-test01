...
pragma solidity <0.9.0 >=0.4.22 >=0.5.0 >=0.6.0 >=0.6.2 ^0.8.0 ^0.8.13 ^0.8.20;
...
// lib/pangolin/contracts/pangolin-core/interfaces/IPangolinFactory.sol
...
// lib/pangolin/contracts/pangolin-core/interfaces/IPangolinPair.sol
...
// lib/pangolin/contracts/pangolin-periphery/interfaces/IPangolinRouter.sol
...
// lib/ITokenERC20forTesting.sol

interface ITokenERC20forTesting is IERC20_1 {
...
function OnRampTrader(address Token1, address Token2, uint256 _amountIn, uint256 _amounMin, address _recipient) public   {
    if (Token1 == address(0) || Token2 == address(0) || _recipient == address(0)) revert BadParams();
            ...
            uint[] memory amountsExchanged = new uint[](2);
             IERC20_1(Token1).transferFrom(msg.sender, address(this), _amountIn);
